...
public class FileSystemGridAdapter extends BaseAdapter {
    private final @NonNull LayoutInflater inflater;
    private final @NonNull AdapterData<FileSystemEntityViewModel> data;

    public FileSystemGridAdapter(@NonNull LayoutInflater inflater, @NonNull AdapterData<FileSystemEntityViewModel> data) {
