...
public class TransmissionReadStream implements TransmissionStream.Read {
    ...
    private final @NonNull InputStream _stream;
    private final @NonNull StreamBandwidth.Tracker.Read _bandwidth;
    ...
    public TransmissionReadStream(@NonNull InputStream stream, @NonNull StreamBandwidth.Tracker.Read bandwidth) {
        _stream = stream;
