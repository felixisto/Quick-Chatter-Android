...
import com.office.quickchatter.utilities.StringFormatting;
...
public class BDTransmissionMessageSegment {
    ...
    public static final @NonNull String MESSAGE_START_SEPARATOR = "![";
    public static final int MESSAGE_TYPE_LENGTH = 4;
    public static final @NonNull String MESSAGE_CLASS_START_SEPARATOR = "<!";
    public static final @NonNull String MESSAGE_CLASS_END_SEPARATOR = "!>";
    public static final int MESSAGE_CLASS_LENGTH = 1;
    public static final @NonNull String MESSAGE_HEADER_START_SEPARATOR = "<!";
    public static final @NonNull String MESSAGE_HEADER_END_SEPARATOR = "!>";
    ...
    public static final @NonNull String MESSAGE_END_SEPARATOR = "]!";
    public static final int MIN_LENGTH = MESSAGE_TYPE_LENGTH + MESSAGE_CLASS_LENGTH + TOTAL_SEPARATOR_LENGTH;

    public static final @NonNull String CLASS_VALUE_START = "0";
    public static final @NonNull String CLASS_VALUE_DATA = "1";
    public static final @NonNull String CLASS_VALUE_END = "2";
    public static final @NonNull String CLASS_VALUE_PING = "3";

    private static final @NonNull byte[] MESSAGE_START_SEPARATOR_BYTES = stringToBytes(MESSAGE_START_SEPARATOR);
    private static final @NonNull byte[] MESSAGE_END_SEPARATOR_BYTES = stringToBytes(MESSAGE_END_SEPARATOR);

    public final @NonNull byte[] data;
    public final @NonNull String dataAsString;

    public static @NonNull BDTransmissionMessageSegment build(@NonNull byte[] bytes) {
    ...
    BDTransmissionMessageSegment(@NonNull byte[] data) {
        this.data = data;
    ...
    private int indexOfBytes(@NonNull byte[] bytes) {
        return indexOfBytes(0, bytes);
    }

    private int indexOfBytes(int startIndex, @NonNull byte[] bytes) {
        if (startIndex < 0) {
            return -1;
        }
