...
public class TransmissionWriteStream implements TransmissionStream.Write {
    ...
    private final @NonNull OutputStream _stream;
    private final @NonNull StreamBandwidth.Tracker.Write _bandwidth;

    private final @NonNull ByteArrayOutputStream _bufferStream;
    private final @NonNull DataOutputStream _buffer;

    private long _totalBytesWritten = 0;

    private final @NonNull Timer _forceFlushTimer;

    public TransmissionWriteStream(@NonNull OutputStream stream, @NonNull StreamBandwidth.Tracker.Write bandwidth) {
        _stream = stream;
    ...
    @Override
    public @NonNull StreamBandwidth getBandwidth() {
        return _bandwidth;
    }
    ...
    private void writeToBufferCache(@NonNull byte[] bytes) throws Exception {
    ...
    private void writeDataAndFlush(@NonNull byte[] currentBytes, int maxBytes, boolean forceFlush) throws Exception {
